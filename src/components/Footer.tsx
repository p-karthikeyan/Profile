...
export default function Footer() {
  ...
  return (
    <footer className="relative py-10 px-6 bg-[#0a0a0a] border-t border-white/5">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            ...
            <span className="text-gray-500 text-sm">Karthik P</span>
          </motion.div>
          ...
          >
            ...
            {" "}by{" "}
            <span className="text-purple-400 font-medium">Karthik P</span>
            {" · "}
            <span>{year}</span>
          </motion.p>
          ...
          >
            ...
            <a
              href="mailto:esakkiraja5028939@gmail.com"
